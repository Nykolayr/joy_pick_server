...
/**
 * Hosted Connect в WebView ориентируется на Accept-Language; без региональных тегов часто уходит en-US и поле телефона с +1.
 * Клиент обязан передать `headers` в loadRequest / loadUrl при открытии account_link_url.
 * @param {string} countryIso2
 * @returns {{ headers: { 'Accept-Language': string } }}
 */
function buildStripeOnboardingWebviewHints(countryIso2) {
  const cc = String(countryIso2 || '').toUpperCase();
  const fallback = 'en-GB, en;q=0.85';
  if (!/^[A-Z]{2}$/.test(cc)) {
    return { headers: { 'Accept-Language': fallback } };
  }
  const byCountry = {
    BE: 'nl-BE, fr-BE, de-BE, en-BE, en;q=0.55',
    NL: 'nl-NL, en-NL, en;q=0.65',
    FR: 'fr-FR, en-FR, en;q=0.65',
    DE: 'de-DE, en-DE, en;q=0.65',
    AT: 'de-AT, en-AT, en;q=0.65',
    CH: 'de-CH, fr-CH, it-CH, rm-CH, en-CH, en;q=0.55',
    LU: 'fr-LU, de-LU, lb-LU, en-LU, en;q=0.55',
    IE: 'en-IE, ga-IE;q=0.45, en;q=0.75',
    GB: 'en-GB',
    GG: 'en-GB',
    JE: 'en-GB',
    IM: 'en-GB',
    CA: 'en-CA, fr-CA, en;q=0.65',
    US: 'en-US',
    BR: 'pt-BR, en-BR, en;q=0.65',
    MX: 'es-MX, en-MX, en;q=0.6',
    ES: 'es-ES, en-ES, en;q=0.65',
    IT: 'it-IT, en-IT, en;q=0.65',
    PT: 'pt-PT, en-PT, en;q=0.65',
    PL: 'pl-PL, en-PL, en;q=0.65',
    CZ: 'cs-CZ, en-CZ, en;q=0.65',
    SK: 'sk-SK, en-SK, en;q=0.65',
    HU: 'hu-HU, en-HU, en;q=0.65',
    RO: 'ro-RO, en-RO, en;q=0.65',
    BG: 'bg-BG, en-BG, en;q=0.65',
    GR: 'el-GR, en-GR, en;q=0.65',
    SE: 'sv-SE, en-SE, en;q=0.65',
    NO: 'nb-NO, nn-NO, en-NO, en;q=0.65',
    DK: 'da-DK, en-DK, en;q=0.65',
    FI: 'fi-FI, en-FI, en;q=0.65',
    EE: 'et-EE, en-EE, en;q=0.65',
    LV: 'lv-LV, en-LV, en;q=0.65',
    LT: 'lt-LT, en-LT, en;q=0.65',
    UA: 'uk-UA, en-UA, en;q=0.65',
    TR: 'tr-TR, en-TR, en;q=0.65',
    RU: 'ru-RU, en-RU, en;q=0.6',
    IL: 'he-IL, en-IL, en;q=0.65',
    AE: 'ar-AE, en-AE, en;q=0.65',
    SA: 'ar-SA, en-SA, en;q=0.65',
    IN: 'hi-IN, en-IN, en;q=0.65',
    JP: 'ja-JP, en-JP, en;q=0.65',
    KR: 'ko-KR, en-KR, en;q=0.65',
    CN: 'zh-CN, en-CN, en;q=0.65',
    AU: 'en-AU',
    NZ: 'en-NZ, mi-NZ;q=0.4, en;q=0.75',
    ZA: 'en-ZA, af-ZA, en;q=0.65',
    EG: 'ar-EG, en-EG, en;q=0.65',
    NG: 'en-NG, en;q=0.75',
    KE: 'sw-KE, en-KE, en;q=0.65',
    AR: 'es-AR, en-AR, en;q=0.65',
    CL: 'es-CL, en-CL, en;q=0.65',
    CO: 'es-CO, en-CO, en;q=0.65',
    PE: 'es-PE, en-PE, en;q=0.65',
    GE: 'ka-GE, en-GE, en;q=0.65',
    AM: 'hy-AM, en-AM, en;q=0.65',
    BY: 'be-BY, ru-BY, en;q=0.6',
    MD: 'ro-MD, ru-MD, en;q=0.6',
    AZ: 'az-AZ, en-AZ, en;q=0.65',
    BA: 'bs-BA, hr-BA, sr-BA, en;q=0.6',
    RS: 'sr-RS, en-RS, en;q=0.65',
    ME: 'sr-ME, en-ME, en;q=0.65',
    MK: 'mk-MK, en-MK, en;q=0.65',
    AL: 'sq-AL, en-AL, en;q=0.65',
    IS: 'is-IS, en-IS, en;q=0.65',
    MT: 'mt-MT, en-MT, en;q=0.65',
    CY: 'el-CY, en-CY, tr-CY;q=0.35, en;q=0.55',
    SI: 'sl-SI, en-SI, en;q=0.65',
    HR: 'hr-HR, en-HR, en;q=0.65',
    KZ: 'kk-KZ, ru-KZ, en;q=0.6'
  };
  const acceptLanguage = byCountry[cc] || `en-${cc}, en;q=0.72`;
...
router.get('/account-status', authenticate, async (req, res) => {
  try {
    ...
    return success(res, {
      ...
      stripe_onboarding_webview: buildStripeOnboardingWebviewHints(
        String(stripeAccount.country || '').toUpperCase()
      )
