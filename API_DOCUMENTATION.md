...
**Важно:** Групповой чат создается автоматически при создании заявки любого типа (wasteLocation, speedCleanup, event). Создатель заявки автоматически добавляется в участники. Участники добавляются автоматически при присоединении к заявке, донате или участии в событии.
...
**Описание:**
Создать групповой чат для заявки (если он не был создан автоматически при создании заявки). Если чат уже существует, возвращает существующий чат. Автоматически добавляет всех участников:
...
**Примечание:** Сообщение также отправляется через Socket.io и SSE всем участникам чата.
