...
5. **Автоматическое удаление**
   ...
   - Если в течение **1 дня** (для проверки, потом вернуть на 7 дней) к заявке никто не присоединился:
     ...
     - Если заявка не была продлена, через **2 дня** (1 день + 1 день ожидания, для проверки, потом вернуть на 8 дней):
       ...
       - Донатерам (включая создателя, если он делал донат) возвращаются деньги
...
7. **Одобрение заявки**
   ...
   - **На бэкенде:**
     ...
     - Все деньги от донатеров (включая создателя, если он делал донат), за вычетом комиссии, уходят исполнителю
...
2. Изменить статус на `rejected`
3. Вернуть деньги:
     - Вернуть деньги всем донатерам (включая создателя, если он делал донат)
