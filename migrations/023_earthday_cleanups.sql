...
CREATE TABLE IF NOT EXISTS earthday_cleanups (
  ...
  continent VARCHAR(64) DEFAULT NULL COMMENT 'Continent (English), from lat/lng',
  country VARCHAR(128) DEFAULT NULL COMMENT 'Country (English), bbox match or NULL',
  location_hint TEXT DEFAULT NULL COMMENT 'UI/debug: continent · approx: country · GeoCodedAddress',
