...
- Для одной пары пользователей и заявки может быть только один `private` чат
...
**Описание:**
Создать приватный чат между двумя пользователями. Если чат уже существует для данной пары пользователей и заявки, возвращается существующий чат со статусом 200 (не 201).
