...
- Участники добавляются автоматически при присоединении к заявке, донате или участии в событии
...
- Проверяется, что текущий пользователь является участником этого чата
